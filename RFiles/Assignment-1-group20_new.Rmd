...
```{r, echo = FALSE,fig.height=3.5, fig.subcap = TRUE,fig.margin = c(0, 0, 0, 0)}
#Graphics
par(mfrow=c(1,2));boxplot(diet_data$preweight, diet_data$weight6weeks, names.arg = c('test', '99'));boxplot(diet_data$weight.lost)
...
Visual inspection of the boxplots suggest that the mean of
...
![The output plot is as above, displaying the required information in a
visualized way.](a4brunPlot.png)
